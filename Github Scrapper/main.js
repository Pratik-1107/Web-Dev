...
request(url, cb);  //made request to home page given to us
...
//Extracted the 3 technologies that are present on home page given to us
...
function singleTopicPage(html) {
    ...
    //Made the folder with the name of that technology page
    ...
    for (let i = 0; i < 8; i++) {
        ...
        //Extracted the name for the repository
        ...
        //***********************************************
        //Had to write this call back function within this function as we need repoFilePath variable
        ...
        function landingPage(html) {
            ...
            //Extracted the issues and append in the .json file named repoFilePath
            let issuesArr = $(".h4");
